...
#from products.models import Product userprofile_receiver
from .models import Order,OrderItem,Item,Address,Payment,Refund,UserProfile
...
def add_to_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        if order.items.filter(item__slug=item.slug).exists():
            ...
            return redirect("ecommerceapp:order-summary")
        else:
...
def remove_from_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        #add msg to display for user that doesnot have an order
...
class CheckoutView(View):
    def get(self,*args, **kwargs):
        try:
            ...
            messages.warning(self.request,"You don't have active order")
            return redirect("ecommerceapp:checkout")
    ...
    def post(self,*args, **kwargs):   
        ...
        try:
            ...
            if form.is_valid():
                ...
                payment_option=form.cleaned_data.get('payment_option')
                if payment_option=='S':
                    return redirect("ecommerceapp:payment",payment_option='stripe')
                elif payment_option=='P':
                    return redirect("ecommerceapp:payment",payment_option='paypal')
                else:
...
class PaymentView(View):
    ...
    def post(self,*args, **kwargs):
            ...
            try:
                if use_default or save:
                    ...
                    charge = stripe.Charge.create(
                        ...
                        # amount='ach_credit_transfer',  # cents
                        # currency="usd",
                        # customer={
        ...
        return redirect("ecommerceapp:/payment/stripe/")        


#for the user to request a refund
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                return redirect("ecommerceapp:request-refund")   
            except ObjectDoesNotExist:
